...
Basic Algorithms:
  ...
  jokenpo_game.c:
  Jogo de Pedra, Papel e Tesoura contra a máquina. Usa estruturas de repetições como if e else, juntamente com as funções rand() e srand.

  logica_beneficio_if.c:
  Uso de estruturas aninhadas.

 sistema_notas_loop.c:
 Sistema interativo para gestão de médias escolares.
 Bem simples utilizando do-while. 
  
 super_trunfo_completo.c:
 Jogo de cartas interativo em que você consegue comparar dois países com: pib, populacao, etc).
 Código focado em aprender o uso da função switch.
